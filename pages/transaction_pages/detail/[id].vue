    ...
    <div v-else>
      ...
      <!-- <div v-if="showStatusModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
        <div class="relative w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg">
          <button @click="showStatusModal = false" class="absolute text-2xl text-gray-500 top-4 right-4 hover:text-black">&times;</button>
          ...
          <div class="relative pl-6 border-l-2 border-blue-500">
            <div v-for="(history, index) in statusHistories" :key="index" class="mb-8">
              <div class="absolute w-4 h-4 bg-blue-500 rounded-full top-1 -left-2"></div>
      ...
      >
        <div
          class="relative bg-white shadow-lg p-6 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto"
        >
          <button
            @click="showStatusModal = false"
            class="absolute text-2xl text-gray-500 top-4 right-4 hover:text-black"
          >
            &times;
          </button>
          ...
          <div class="relative ml-4">
            <div
              class="top-0 left-2 absolute border-blue-400 border-l-2 border-dashed w-0.5 h-full"
            ></div>
            <!-- Garis putus-putus -->
