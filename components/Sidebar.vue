<template>
  ...
  > -->
    <!-- <div
    :class="isSidebarOpen ? 'w-64' : 'w-16'"
    class="fixed flex flex-col bg-gray-800 min-h-screen max-h-screen overflow-y-auto text-white transition-all duration-300"
  > -->
	<div
    :class="isSidebarOpen ? 'w-64' : 'w-16'"
    class="fixed flex flex-col bg-gray-800 min-h-screen max-h-screen text-white transition-all duration-300"
  >
