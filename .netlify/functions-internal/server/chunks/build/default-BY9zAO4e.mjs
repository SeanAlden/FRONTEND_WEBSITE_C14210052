  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><header class="fixed top-0 left-0 right-0 flex items-center justify-between px-6 py-4 bg-gray-400 shadow"><h1 class="text-xl font-semibold"></h1><div class="relative flex align-items-xl-end"><div><div class="flex items-center gap-6"><button class="w-10 h-10 overflow-hidden rounded-full"><img${ssrRenderAttr("src", _imports_0$1)} alt="Notification" class="object-cover w-full h-full"></button><button class="w-10 h-10 overflow-hidden bg-gray-300 rounded-full focus:outline-none"><img${ssrRenderAttr(
        "src",
        user.value.profile_image ? ("useApi" in _ctx ? _ctx.useApi : unref(useApi))(`/storage/profile_images/${user.value.profile_image}`) : "/assets/images/photo_default.png"
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: [__props.isSidebarOpen ? "w-64" : "w-16", "fixed flex flex-col bg-gray-800 min-h-screen max-h-screen text-white transition-all duration-300"]
      }, _attrs))} data-v-efc0fff6><div class="flex justify-between items-center p-4" data-v-efc0fff6>`);
      if (__props.isSidebarOpen) {
        _push(`<span class="font-bold text-red-400 text-lg" data-v-efc0fff6>Asia Raya Cashier</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="hover:bg-gray-700 p-2 rounded" data-v-efc0fff6><img${ssrRenderAttr("src", _imports_0)} alt="Toggle" class="w-6 h-6" data-v-efc0fff6></button></div><div class="flex-1 overflow-y-auto" data-v-efc0fff6><nav class="flex flex-col space-y-2 mt-4" data-v-efc0fff6>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_1)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Dashboard</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_2)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Sales Reports</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_3)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Categories</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`<div data-v-efc0fff6><div class="flex justify-between items-center hover:bg-gray-700 p-3 cursor-pointer" data-v-efc0fff6><div class="flex items-center" data-v-efc0fff6><img${ssrRenderAttr("src", _imports_4)} class="mr-3 w-6 h-6" data-v-efc0fff6>`);
      if (__props.isSidebarOpen) {
        _push(`<span data-v-efc0fff6>Products</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.isSidebarOpen) {
        ...
        )} class="w-4 h-4 transition-transform duration-300" data-v-efc0fff6>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (isProductsOpen.value) {
        _push(`<div class="space-y-2 ml-9 text-sm" data-v-efc0fff6>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_5)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Transactions</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_6)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Employees</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_7)} class="mr-3 w-6 h-6" data-v-efc0fff6${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-efc0fff6${_scopeId}>Analisis C4.5</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-efc0fff6"]]);
...
//# sourceMappingURL=default-BY9zAO4e.mjs.map
