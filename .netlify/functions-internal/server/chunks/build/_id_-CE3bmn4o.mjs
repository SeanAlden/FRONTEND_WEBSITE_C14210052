    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (employee.value) {
        _push(`<div class="p-6 bg-white rounded-lg shadow-md"><div class="flex flex-col items-center text-center md:flex-col md:text-left"><img${ssrRenderAttr(
          "src",
          employee.value.employee_photo ? `http://localhost:8000/storage/${employee.value.employee_photo}` : "/assets/images/photo_default.png"
...
//# sourceMappingURL=_id_-CE3bmn4o.mjs.map
