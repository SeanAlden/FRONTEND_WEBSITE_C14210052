  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(form.stocks, (stock, index) => {
        _push(`<div class="flex gap-2 mb-2"><input${ssrRenderAttr("value", stock.exp_date)} type="date" required class="w-1/2 p-2 border">`);
...
//# sourceMappingURL=add_product-BF4B2Kic.mjs.map
