...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-e35c4380><div class="flex items-center justify-between p-4" data-v-e35c4380>`);
      if (__props.isSidebarOpen) {
        _push(`<span class="text-lg font-bold text-red-400" data-v-e35c4380> Asia Raya Cashier </span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="p-2 rounded hover:bg-gray-700" data-v-e35c4380><img${ssrRenderAttr("src", _imports_0)} alt="Toggle" class="w-6 h-6" data-v-e35c4380></button></div><div class="flex-1 overflow-y-auto" data-v-e35c4380><nav class="flex flex-col mt-4 space-y-2" data-v-e35c4380>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_1)} class="w-6 h-6 mr-3" data-v-e35c4380${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-e35c4380${_scopeId}>Dashboard</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_2)} class="w-6 h-6 mr-3" data-v-e35c4380${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-e35c4380${_scopeId}>Sales Reports</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_3)} class="w-6 h-6 mr-3" data-v-e35c4380${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-e35c4380${_scopeId}>Categories</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(`<div data-v-e35c4380><div class="flex items-center justify-between p-3 cursor-pointer hover:bg-gray-700" data-v-e35c4380><div class="flex items-center" data-v-e35c4380><img${ssrRenderAttr("src", _imports_4)} class="w-6 h-6 mr-3" data-v-e35c4380>`);
      if (__props.isSidebarOpen) {
        _push(`<span data-v-e35c4380>Products</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.isSidebarOpen) {
        ...
        )} class="w-4 h-4 transition-transform duration-300" data-v-e35c4380>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (isProductsOpen.value) {
        _push(`<div class="space-y-2 text-sm ml-9" data-v-e35c4380>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_5)} class="w-6 h-6 mr-3" data-v-e35c4380${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-e35c4380${_scopeId}>Transactions</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_6)} class="w-6 h-6 mr-3" data-v-e35c4380${_scopeId}>`);
            if (__props.isSidebarOpen) {
              _push2(`<span data-v-e35c4380${_scopeId}>Employees</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e35c4380"]]);
...
//# sourceMappingURL=default-BFe37_cU.mjs.map
