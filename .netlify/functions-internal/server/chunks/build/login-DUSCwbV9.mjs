...
import { a as useRouter, e as useCookie, b as useNuxtApp } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (recaptchaAvailable.value) {
        _push(ssrRenderComponent(_component_Recaptcha, {
...
//# sourceMappingURL=login-DUSCwbV9.mjs.map
